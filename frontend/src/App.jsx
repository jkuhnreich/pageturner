...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",direction:"rtl",background:C.bg,position:"relative",overflow:viewUserId?"hidden":"auto",height:viewUserId?"100vh":"auto"}}>
      <style>{CSS}</style>
